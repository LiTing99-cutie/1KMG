################################################
#File Name: rerun_2021_12_30.sh
#Author: LiTing
#Mail: liting@stu.pku.edu.cn
#Created Time: Thu 30 Dec 2021 10:42:21 AM CST
################################################

#!/bin/sh 


# CP1_hg38.bwt2pairs.validPairs are too small
...
-g hg38 -j /home/user/data2/lit/software/juicer_tools_1.22.01.jar > log/allValidPairs_to_hic_CP.log 2>&1 &

echo ".hic file is ready"

# nohup bash ./rerun_2021_12_30.sh &> hicpro_fetal_brain_CP.log &